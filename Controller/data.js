// we create multiple functions here and then export it
...
const bollywood = (req,res)=>{
  ...
  const permaData = data.filter(item=>item.cat===category)
  res.send(permaData)
}
...
const latestData = (req,res)=>{
  const lastestData1 = data.sort(function (a,b){
    return new Date(b.Date) - new Date(a.Date)
  })
  res.send(lastestData1)
}

const topPost = (req,res) =>{
  const topData = data.sort((a,b)=> b.Likes -a.Likes)
  res.send(topData)
}

module.exports = {bollywood,allData,latestData,topPost};